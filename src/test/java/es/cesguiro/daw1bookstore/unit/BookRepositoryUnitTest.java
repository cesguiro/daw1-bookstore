...
import es.cesguiro.daw1bookstore.mock.BookDaoMock;
...
public class BookRepositoryUnitTest {
    ...
    private final BookRepository bookRepository = new BookRepositoryImpl(new BookDaoMock());
    ...
    public void testEmptyList() {
        BookRepository emptyBookRepository = new BookRepositoryImpl(new BookDao() {
            @Override
        ...
        List<Book> result = emptyBookRepository.findAll();
